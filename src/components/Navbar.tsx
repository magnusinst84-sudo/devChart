    ...
    return (
        <div className="flex justify-between items-center h-auto font-black bg-[#000000] text-white p-4 border-b-4 border-black">
            ...
            <div className="flex gap-4">
                <Link href="/rooms">
                    <button className="bg-white text-black border-2 border-black px-4 py-2 font-black uppercase shadow-[4px_4px_0px_#000] hover:translate-y-[2px] hover:translate-x-[2px] hover:shadow-[2px_2px_0px_#000] transition-all">
                        Rooms
                    </button>
                </Link>
